          ...
          <DynamicCard hoverEffect={false} className="border border-dark-border bg-dark-panel p-6">
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                 <div>
                   <label className="text-sm font-medium text-text-muted mb-2 block">Game</label>
                   <select 
                     value={category}
                 ...
                 <div>
                   <label className="text-sm font-medium text-text-muted mb-2 block">Trade Type</label>
                   <select 
                     value={tradeType}
