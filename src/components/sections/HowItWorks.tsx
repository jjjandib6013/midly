...
const STEPS = [
  {
    ...
    description:
      "Browse verified listings or create your own. Midly's marketplace matches buyers and sellers across Dota 2, Valorant, CS2, and more — with trust scores visible upfront.",
    icon: ShieldCheck,
    accent: "#3FE56C",
  },
  {
  ...
  },
  {
    ...
    description:
      "The buyer deposits into Midly's escrow vault. Funds are visible to both parties — no one, not even the Midly team, can withdraw them mid-trade.",
    icon: Lock,
    accent: "#3B82F6",
  },
  {
    ...
    description:
      "Both parties undergo frictionless, device-bound identity verification. Midly ensures you're trading with a real, accountable human — not a burner account.",
    icon: UserCheck,
    accent: "#F59E0B",
  },
  {
